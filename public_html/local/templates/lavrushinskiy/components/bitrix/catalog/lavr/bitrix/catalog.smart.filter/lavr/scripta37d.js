function JCSmartFilter(ajaxURL, viewMode, params)
{
	...
	//обновляем страницу каталога и записываем в url новый адрес
	$.post(
		this.ajaxURL,
		function (data) {
			$('.main-catalog-list').html($(data).find('.main-catalog-list').html());
			$("[data-flats_count]").text($(data).find(".flats__items .flats__item").length);
			$(".smart-filter-button-share").html($(data).find(".smart-filter-button-share").html());
		}
	);
}
